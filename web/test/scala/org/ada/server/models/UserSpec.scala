...
class UserSpec extends AsyncFlatSpec {
  ...
  it should "be serializable" in {
    ...
    assert(serial == "{\"_id\":{\"$oid\":\"5dc029c50c00000f059e1ccd\"},\"userId\":\"userName\",\"email\":\"userName@me.com\",\"roles\":[\"ROLE_A\",\"ROLE_B\"],\"permissions\":[\"PERM_A\",\"PERM_B\"],\"locked\":true}")
  }

  it should "be de-serializable" in {
    val serial = "{\"_id\":{\"$oid\":\"5dc029c50c00000f059e1ccd\"},\"userId\":\"userName\",\"email\":\"userName@me.com\",\"roles\":[\"ROLE_A\",\"ROLE_B\"],\"permissions\":[\"PERM_A\",\"PERM_B\"],\"locked\":true}"
