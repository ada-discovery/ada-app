...
libraryDependencies ++= Seq(
  ...
  "org.webjars" % "highcharts" % "4.2.7", // "4.2.5",
...
//  "com.google.inject.extensions" % "guice-spring" % "4.0", // so we can initialize spring container in Guice
  ...
  "com.banda" % "incal" % "0.1.2" exclude("org.springframework", "spring-context") exclude("org.springframework", "spring-test") exclude("org.springframework", "spring-web") exclude("org.springframework", "spring-webmvc")
