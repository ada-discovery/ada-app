...
class UserIdByRoleProviderImpl @Inject()(committeeRepo: RequestSettingRepo, dataSetSettingRepo: DataSetSettingRepo) extends UserIdByRoleProvider[Map[Role.Value, Traversable[BSONObjectID]]](committeeRepo, dataSetSettingRepo) {
