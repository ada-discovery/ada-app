...
class ScalarNumericDistributionCountsConverter extends ScalarDoubleConverter {
  override def specificUseClass = Some(NumericDistributionCountsCalc.getClass)
}
...
private[jsonin] abstract class ScalarConverter[T: TypeTag] extends JsonInputConverter[Option[T]] {
...
private[jsonin] abstract class ScalarDoubleConverter extends JsonInputConverter[Option[Double]] {
...
private[jsonin] abstract class ArrayConverter[T: TypeTag] extends JsonInputConverter[Array[Option[T]]] {
...
private[jsonin] abstract class ArrayDoubleConverter extends JsonInputConverter[Array[Option[Double]]] {
...
private[jsonin] abstract class SeqDoubleConverter extends JsonInputConverter[Seq[Option[Double]]] {
...
private[jsonin] abstract class AllDefinedSeqDoubleConverter extends JsonInputConverter[Seq[Double]] {
...
private[jsonin] abstract class TupleConverter[T1: TypeTag, T2: TypeTag] extends JsonInputConverter[(Option[T1], Option[T2])] {
...
private[jsonin] abstract class ScalarGroupDoubleConverter[G: TypeTag] extends JsonInputConverter[(Option[G], Option[Double])] {
...
private[jsonin] abstract class ArrayTupleConverter[T1: TypeTag, T2: TypeTag] extends JsonInputConverter[Array[(Option[T1], Option[T2])]] {
...
private[jsonin] abstract class ArrayGroupDoubleConverter[G: TypeTag] extends JsonInputConverter[Array[(Option[G], Option[Double])]] {
...
private[jsonin] abstract class ScalarNumericConverter[T: TypeTag] extends JsonInputConverter[Option[T]] {
...
private[jsonin] abstract class ArrayNumericConverter[T: TypeTag] extends JsonInputConverter[Array[Option[T]]] {
...
private[jsonin] abstract class GroupScalarNumericConverter[G: TypeTag, T: TypeTag] extends JsonInputConverter[(Option[G], Option[T])] {
...
private[jsonin] abstract class ArrayGroupNumericConverter[G: TypeTag, T: TypeTag] extends JsonInputConverter[Array[(Option[G], Option[T])]] {
...
private[jsonin] abstract class StringGroupScatterConverter[T1: TypeTag, T2: TypeTag] extends JsonInputConverter[GroupTupleCalcIOTypes.IN[String, T1, T2]] {
