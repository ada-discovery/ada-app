...
private[stats] class AllDefinedSeqBinMinCalc extends AllDefinedSeqBinAggCalc[Option[Double]] {
...
private[stats] object SeqBinMinCalcAux extends SeqBinCalc(AllDefinedSeqBinMinCalc.apply)
