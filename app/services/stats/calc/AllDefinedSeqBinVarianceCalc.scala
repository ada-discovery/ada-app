...
private[stats] class AllDefinedSeqBinVarianceCalc extends AllDefinedSeqBinAggCalc[(Double, Double, Int)] {
...
private[stats] object SeqBinVarianceCalcAux extends SeqBinCalc(AllDefinedSeqBinVarianceCalc.apply)
