...
private[stats] class AllDefinedSeqBinMaxCalc extends AllDefinedSeqBinAggCalc[Option[Double]] {
...
private[stats] object SeqBinMaxCalcAux extends SeqBinCalc(AllDefinedSeqBinMaxCalc.apply)
