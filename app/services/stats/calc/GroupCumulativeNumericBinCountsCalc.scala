...
private[stats] class GroupCumulativeNumericBinCountsCalc[G] extends Calculator[GroupCumulativeNumericBinCountsCalcTypePack[G]] with CumulativeNumericBinCountsCalcFun {
