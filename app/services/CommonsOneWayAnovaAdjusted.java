 ...
 * @since 1.2
 */
public class CommonsOneWayAnovaAdjusted {

    private static final double DEFAULT_EPSILON = 1E-300;


    /**
     * Default constructor.
     */
    public CommonsOneWayAnovaAdjusted() {
    }
    ...
    public double anovaPValue(final Collection<double[]> categoryData)
        ...
        return 1.0 - cumulativeProbability(a.dfbg, a.dfwg, a.F);
    ...
    public double anovaPValue(final AnovaStats a)
            throws NullArgumentException, DimensionMismatchException,
            ConvergenceException, MaxCountExceededException {
    ...
    private double cumulativeProbability(
        ...
        if (x <= 0) {
            ...
            ret = Beta.regularizedBeta((n * x) / (m + n * x),0.5 * n,0.5 * m, DEFAULT_EPSILON);
        }
        return ret;
    }
     ...
     */
    public AnovaStats anovaStats(final Collection<double[]> categoryData)
            throws NullArgumentException, DimensionMismatchException {
    ...
    private AnovaStats anovaStats(
        final Collection<SummaryStatistics> categoryData,
        final boolean allowOneElementData
    ) throws NullArgumentException, DimensionMismatchException {
     ...
     */
    protected static class AnovaStats {

        /** Degrees of freedom in numerator (between groups). */
        protected final int dfbg;

        /** Degrees of freedom in denominator (within groups). */
        protected final int dfwg;
