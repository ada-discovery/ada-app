...
private class RCStatesWindow(override val uid: String, reservoirRunnableFactory: ReservoirRunnableFactory) extends Transformer with DefaultParamsWritable {
  ...
  protected[ml] final val inputNodeNum: Param[Int] = new Param[Int](this, "inputNodeNum", "# reservoir nodes")
  protected[ml] final val bias: Param[Double] = new Param[Double](this, "bias", "Bias")
  protected[ml] final val nonBiasInitial: Param[Double] = new Param[Double](this, "nonBiasInitial", "Non-bias Initial")
  ...
  protected[ml] final val reservoirInDegree = new Param[Int](this, "reservoirInDegree", "Reservoir in-degree")

  protected[ml] final val reservoirInDegreeDistribution = new Param[RandomDistribution[Integer]](this, "reservoirInDegreeDistribution", "Reservoir in-degree distribution")

  protected[ml] final val reservoirEdgesNum = new Param[Int](this, "reservoirEdgesNum", "# reservoir edges")

  protected[ml] final val reservoirPreferentialAttachment = new Param[Boolean](this, "reservoirPreferentialAttachment", "Use preferential attachment to generate a reservoir?")
  setDefault(reservoirPreferentialAttachment, false)

  protected[ml] final val reservoirBias = new Param[Boolean](this, "reservoirBias", "Use bias (weight) for a reservoir?")
  setDefault(reservoirBias, false)

  protected[ml] final val reservoirCircularInEdges = new Param[Seq[Int]](this, "reservoirCircularInEdges", "# reservoir circular in-edges per node if spatial/toroidal topology is to be generated")

  protected[ml] final val reservoirAllowSelfEdges = new Param[Boolean](this, "reservoirAllowSelfEdges", "Allow self-edges for a reservoir")
  setDefault(reservoirAllowSelfEdges, true)

  protected[ml] final val reservoirAllowMultiEdges = new Param[Boolean](this, "reservoirAllowMultiEdges", "Allow multi edges for a reservoir")
  setDefault(reservoirAllowMultiEdges, false)

  protected[ml] final val inputReservoirConnectivity = new Param[Double](this, "inputReservoirConnectivity", "Input reservoir connectivity")

  protected[ml] final val weightDistribution = new Param[RandomDistribution[jl.Double]](this, "weightDistribution", "Weight distribution")

  protected[ml] final val reservoirSpectralRadius = new Param[Double](this, "reservoirSpectralRadius", "Reservoir spectral radius")

  protected[ml] final val reservoirFunctionType = new Param[ActivationFunctionType](this, "reservoirFunctionType", "Reservoir function type")

  protected[ml] final val reservoirFunctionParams = new Param[Seq[Double]](this, "reservoirFunctionParams", "Reservoir function params")
  setDefault(reservoirFunctionParams, Nil)

  protected[ml] final val perNodeReservoirFunctionWithParams = new Param[Stream[(ActivationFunctionType, Seq[jl.Double])]](this, "perNodeReservoirFunctionWithParams", "Per-node reservoir function with params")

  protected[ml] final val inputCol: Param[String] = new Param[String](this, "inputCol", "input column name")
  protected[ml] final val orderCol: Param[String] = new Param[String](this, "orderCol", "order column name")
  protected[ml] final val outputCol: Param[String] = new Param[String](this, "outputCol", "output column name")
...
class RCStatesWindowFactory @Inject() (reservoirRunnableFactory: ReservoirRunnableFactory) {
  ...
  def applyInPlace(
    ...
    SparkUtil.transformInPlaceWithParamGrids(
