...
class MergeMPowerTrainingTestingNormsOutboundDataSets @Inject()(dataSetService: DataSetService) extends InputFutureRunnableExt[MergeMPowerTrainingTestingNormsOutboundDataSetsSpec] {
